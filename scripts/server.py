...
parser.add_argument('-sub', help='for providing no. of subjects', metavar='2', action='store', dest='n_subjects', default=2, type=int)
...
if __name__ == "__main__":
	...
	robot_action_server = RobotActionsServer(books, root_path, args.headless == 1, args.action_seed)
	server()
